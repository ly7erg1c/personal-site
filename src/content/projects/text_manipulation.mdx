...
date: 5-24-2024
description: Simple python tool for the manipulation of text to preform various text operations/extract various artifacts.
image: ../assets/text-manipulation.png
info:
  - text: GitHub
    link: https://github.com/ly7erg1c/text_manipulation
    icon:
      type: lucide
      name: github
---

# [Text Manipulation Tool](https://github.com/ly7erg1c/text_manipulation)
